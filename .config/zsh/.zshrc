...
HISTSIZE=1000000000
SAVEHIST=1000000000
HISTORY_IGNORE='(cd|cd ..|less *|ls|ls *|command -v *|which *|cp *|mv *|rm *|cal|cal *|bash|dash|dash -E|d|[1-9]|sx|qwe|sd|da|ds|sc|cs|v|zxc|sdfa *|sdfa -p *|sdfc|sdfd|sdfd *|sdfs|sdfp|cpu|mem|t|ta *|kj|gss|gd|gaf|gc|gc -a|gp|gpf|ggp|gbd|nj|gch -|gco|gct|ggl|ggl *|gl|gmt|gurm|gres|gfp|gwl|gwa|gwr|gst|gstu|gstp|gstf|gstl|gcd)'
