...
call s:hi('LineNr', s:none, s:bg_0, s:dim_0, s:none)
...
call s:hi('CursorLineNr', s:none, s:bg_0, s:dim_0, s:none)
...
call s:hi('LineNrAbove', s:none, s:none, s:bg_2, s:none)
...
call s:hi('SpellBad', s:undercurl, s:none, s:none, s:red)
call s:hi('SpellCap', s:undercurl, s:none, s:none, s:blue)
call s:hi('SpellLocal', s:undercurl, s:none, s:none, s:cyan)
call s:hi('SpellRare', s:undercurl, s:none, s:none, s:magenta)
...
call s:hi('VertSplit', s:nocombine, s:none, s:base, s:none)
