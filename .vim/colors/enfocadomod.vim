...
call s:hi('ColorColumn', s:none, s:bg_1, s:none, s:none)
...
call s:hi('FileLink', s:none, s:none, s:cyan, s:none)
...
call s:hi('PmenuSbar', s:nocombine, s:bg_0, s:none, s:none)
call s:hi('PmenuSel', s:none, s:bg_0, s:fg_1, s:none)
...
call s:hi('SpellRare', s:none, s:none, s:br_violet, s:none)
call s:hi('StatusLine', s:nocombine, s:bg_0, s:dim_0, s:none)
call s:hi('StatusLineNC', s:nocombine, s:bg_0, s:bg_2, s:none)
...
call s:hi('Link', s:none, s:none, s:cyan, s:cyan)
...
call s:hi('String', s:nocombine, s:none, s:cyan, s:cyan)
call s:hi('Text', s:nocombine, s:none, s:fg_0, s:none)
call s:hi('Todo', s:none, s:bg_0, s:br_cyan, s:none)
